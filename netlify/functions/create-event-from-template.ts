/**
 * Netlify Function: Create Event from Template
 * Adapted from Vercel API: create-event-from-template.ts
...
export const handler: Handler = async (event, context) => {
  ...
  try {
    ...
    const { default: vercelHandler } = await import('../../api/create-event-from-template.ts');
