/**
 * Netlify Function: PartyCrew Crewing With
 * Adapted from Vercel API: partycrew/crewing-with.ts
...
export const handler: Handler = async (event, context) => {
  ...
  try {
    ...
    const { default: vercelHandler } = await import('../../api/partycrew/crewing-with.ts');
