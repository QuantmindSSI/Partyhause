...
|--------------|-------|-------------|
| `MAILERSEND_API_TOKEN` | `***REDACTED_MAILERSEND_TOKEN***` | MailerSend API key |
| `MAILERSEND_FROM_EMAIL` | `dara@partyhause.com` | Verified sender email |
| `VITE_MAILERSEND_API_TOKEN` | `***REDACTED_MAILERSEND_TOKEN***` | Fallback for API |
...
# Paste: ***REDACTED_MAILERSEND_TOKEN***
